    ...
    return (
        <div className="container flex flex-col bg-darkerGray mx-auto items-center justify-around px-12 py-24 space-y-15 md:flex-row md:space-x-20">
            <div className="flex flex-col space-y-2 text-center md:text-left">
                ...
                <p className="text-lightGray text-sm max-w-100">A passionate amd dedicated junior web developer, driven by the ever-evolving world of technology and its limitless possibilities.</p>
            </div>
